...
Alice creates a `.gitpod.yml` configuration file at the root of her project, then adds [start tasks](/docs/configure/projects/tasks) such as the following:
...
\* She gets that by installing the [Gitpod browser extension](/docs/configure/users/browser-extension). Alternatively, she could prefix the issue URL with `gitpod.io/#<issue-url>` to open a new developer environment.
