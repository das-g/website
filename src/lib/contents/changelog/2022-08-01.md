...
- `gp` has now a new `timeout` namespace letting you to [show](https://www.gitpod.io/docs/references/gp-cli#show) and [extend](https://www.gitpod.io/docs/references/gp-cli#extend) timeout of a running workspace.
