      ...
      items: [
        ...
        },
        {
          ...
          list: [
            ...
            'prefixes the issue URL with gitpod.io/#&lang;issue-url&rang; or uses the Gitpod <a href="/docs/configure/users/browser-extension">browser extension</a>',
          ],
        },
        {
          term: "Switch context",
          list: [
            "opens new browser tab",
            'prefixes the PR URL with gitpod.io/#&lang;issue-url&rang; or uses the Gitpod <a href="/docs/configure/users/browser-extension">browser extension</a>',
