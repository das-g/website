...
You can also automate this in your [`.gitpod.yml`](/docs/configure/projects/gitpod-yaml) file, so that every time you start a new workspace your preview is ready to go. For example:
